import { writeFileSync, copyFileSync, existsSync, readFileSync, appendFileSync } from 'node:fs';
...
program.argument('<algo>', 'The name of the directory inside "src/main/" to activate');
program.argument('<region>', 'The region suffix to append to rendered title components.');
